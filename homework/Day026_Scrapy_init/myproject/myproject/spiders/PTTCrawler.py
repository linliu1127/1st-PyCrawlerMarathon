...
#使用方式https://zhuanlan.zhihu.com/p/48047813
# 範例目標網址: https://www.ptt.cc/bbs/Gossiping/M.1557928779.A.0C1.html
class PttcrawlerSpider(scrapy.Spider):
    name = 'PTTCrawler'
    allowed_domains = ['www.ptt.cc']
    start_urls = ['https://www.ptt.cc/bbs/Gossiping/M.1580809295.A.548.html']
    cookies = {'over18': '1'}
    ...
    def parse(self, response):
        ...
        yield data #https://blog.blackwhite.tw/2013/05/python-yield-generator.html
